...
public class MovieController {
    ...
    public ResponseEntity<ResponseMessageDTO> uploadPoster(@PathVariable(value="movieId") UUID movieId, @RequestPart("file") @ApiParam(value="File", required=true) MultipartFile file) {
